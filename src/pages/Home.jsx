...
const Home = () => {
    return (
        <main className="bg-mountain bg-cover bg-no-repeat h-full flex">
            <div className="px-2 lg:px-0 text-white gap-4 md:gap-10 text-center flex flex-col items-center justify-center mx-auto max-w-lg md:max-w-3xl">
                ...
                <Link to="vans" className="bg-[#FF8C38] rounded-lg hover:bg-[#f8a56b] py-2 px-10 md:px-14 text-base md:text-lg font-bold leading-8">Find your van</Link>
            </div>
        </main>
    );
}
